...
return [ //Configuração dos campos
    ...
    "FLAG_ATUACAO_ARTES_CENICAS" => "field_69",
    "FLAG_ATUACAO_AUDIOVISUAL" => "field_69",
    "FLAG_ATUACAO_MUSICA" => "field_69",
    "FLAG_ATUACAO_ARTES_VISUAIS" => "field_69",
    "FLAG_ATUACAO_PATRIMONIO_CULTURAL" => "field_69",
    "FLAG_ATUACAO_MUSEUS_MEMORIA" => "field_69",
    "FLAG_ATUACAO_HUMANIDADES" => "field_69",
    "FAMILIARCPF" => 'field_57',
    "GRAUPARENTESCO" => 'field_57',
